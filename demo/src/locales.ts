...
export const translations: Record<'en' | 'zh', TranslationSchema> = {
  ...
  zh: {
    ...
    repositoryTarget: "分析目标仓库:",
    installedStatus: "对比历史版本:",
    registryLatest: "最新发布版本:",
    coreHighlightsLabel: "核心改进与架构升级",
    noHighlightsText: "未分析到重大的功能或架构变更。通常包含日常优化与微调。",
    criticalFixesLabel: "漏洞修复与关键解决",
    noCriticalFixesText: "未检测到严重的安全漏洞（CVE）或崩溃修复，当前版本表现稳定可靠。",
    breakingChangesLabel: "破坏性变更与升级风险",
    ...
    coreEnhancements: "核心改进与架构升级",
    noSignificantModifications: "未分析到重大的功能或架构变更。通常包含日常优化与微调。",
    criticalResolutions: "漏洞修复与关键解决",
    noSevereSecurity: "未检测到严重的安全漏洞（CVE）或崩溃修复，当前版本表现稳定可靠。",
    breakingChangesTitle: "破坏性变更与升级风险",
    painlessMigration: "无痛过渡路线图。未登记导致接口不兼容或无法运行的回退风险。"
  }
};
